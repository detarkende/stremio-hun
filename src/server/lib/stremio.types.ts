...
export interface MetaDetail extends MetaPreview {
  ...
  behaviorHints?:
    | {
        ...
        /**
         * Set to true to explicitly state that this meta item has scheduled videos (e.g. episodes that will be released in the future)
         */
...
export interface MetaVideo {
  ...
  released: string;
  /**
   * ISO 8601, first air date of the episode.
   *
   * e.g. "2010-12-06T05:00:00.000Z"
   */
  firstAired?: string;
